...
import type { SectionItem, TocItem } from '../types/api';
...
export function DivisionInformation({ item, viewMode }: DivisionInformationProps) {
  ...
  const pageCount = item.end_page_number 
    ? item.end_page_number - item.start_page_number + 1
    : null;
